...
public class WebSiteController {
	...
	public String greetingSubmit(@ModelAttribute UIData uiData, Model model) {
		//Flight[] flights = restClient.postForObject("http://localhost:8090/search/get", uiData.getSearchQuery(), Flight[].class);
	...
	public String ConfirmBooking(@ModelAttribute UIData uiData, Model model) {
		...
		long bookingId = 0;
		try {
			//bookingId = restClient.postForObject("http://localhost:8060/booking/create", booking, long.class);
			//bookingId =
	...
	public String searchBookingSubmit(@ModelAttribute UIData uiData, Model model) {
		...
		//BookingRecord booking = restClient.getForObject("http://localhost:8060/booking/get/" + id, BookingRecord.class);
	...
	public String bookQuery(@PathVariable String flightNumber, @PathVariable String origin,
		...
		//long checkinId = restClient.postForObject("http://localhost:8070/checkin/create", checkIn, long.class);
